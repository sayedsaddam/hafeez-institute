                    ...
                    <div class="row smooth-scroll">
                        <div class="col-md-12 pt-3">
                            <div class="white-text text-center pt-5">
                                ...
                                <h5 class="text-uppercase font-weight-bold wow fadeIn" data-wow-delay="0.4s"><mark>Gamer & TikToker</mark></h5>
                ...
                <div class="row features-big text-center wow fadeIn" data-wow-delay="0.4s">
                    ...
                    <div class="col-md-4 mb-5">
                        ...
                        <div class="card card-body yellow hoverable">
                            ...
                            <h5 class="font-weight-bold text-uppercase mb-4">TikToker</h5>
                            <p class="dark-grey-text">Creating video content on TikTok.</p>
                        </div>
                        <!--/.Panel-->
                ...
                <section id="skills">
                    ...
                    <div class="row py-5">
                        ...
                        <div class="d-flex justify-content-start">
                            <h4 class="text-center text-uppercase mb-5 pb-3 mt-4 wow fadeIn" data-wow-delay="0.2s">My <strong>experience</strong></h4>
                                ...
                                <blockquote class="blockquote bq-warning mt-1 mb-4">
                                    <div class="row"> <i class="fas fa-briefcase fa-x mb-1 mr-3 ml-3" aria-hidden="true"></i>
                                        <h5 class="font-weight-bold mb-3">TikToker <span class="badge badge-info">11 Mos</span></h5> </div>
                                    <p class="font-weight-bold ml-1 dark-grey-text mb-2">March, 2019 - Jan, 2020</p>
                                    <p class="mb-0 ml-1 light-grey-text">TikTok video content.</p>
                                </blockquote>
                        </div>
                        <!--/First column-->
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <p class="black-text text-uppercase font-weight-bold pt-3" align="justify">TikTok</p>
                                <div class="md-progress">
